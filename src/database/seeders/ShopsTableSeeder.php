...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $image1 = $this->downloadImage('https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg');
        $image2 = $this->downloadImage('https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg');
        $image3 = $this->downloadImage('https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg');
        $image4 = $this->downloadImage('https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg');
        $image5 = $this->downloadImage('https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg');
    ...
    private function downloadImage($url)
    {
        try {
            ...
            if ($response->successful()) {
                ...
                $fileName = 'shops/' . uniqid() . '.' . $extension;
